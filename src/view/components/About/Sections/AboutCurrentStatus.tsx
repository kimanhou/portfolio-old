    ...
    return(
        <div className="about-current-status">
          ...
          <Text english=". I started in Europe before making my way to South East Asia. I was in Thailand when the COVID-19 pandemic hit the world and had to return to France at the end of March 2020." 
                french=". J'ai commencé par l'Europe avant de continuer mon chemin vers l'Asie du Sud-Est. J'étais en Thaïlande lorsque la pandémie de la COVID-19 a frappé le monde, ce qui m'a forcée à rentrer en France fin mars 2020."/>
          <br></br>
          ...
          <Text english=" and to help two local businesses create their website. This allowed me to expand my skills on both " 
                french =" et aider deux petits commerces à créer leur site web. Cette expérience m'a permis de développer mes compétences en "/>
          ...
          <Text english=" while waiting for the sanitary situation to improve enough to allow me to resume my travelling." french=" en attendant que la situation sanitaire ne s'améliore et de pouvoir reprendre mon voyage."/>
        </div>
    );
}
